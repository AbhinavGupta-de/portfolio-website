...
const Contact = () => {
	return (
		<div>
			...
			<div className="flex md:flex-row flex-col gap-5 mt-5 p-5 justify-between">
				...
				<div className="flex flex-col items-center gap-3 border-2 border-solid md:w-1/5 p-5">
